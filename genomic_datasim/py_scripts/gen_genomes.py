...
def main():
    ...
    present_individuals = int(args.refs[0]) + 1
    ...
    print(f'branch scale factor used = {branch_scale:.2e}')
    print(f'recommended branch scale factor = {rec_branch:.2e}')
